...
static magicWeaponTable = [
  ...
  { range: [95], weapon: 'Maul', type: 'Melee' },
  { range: [96], weapon: 'Pole Arm', type: 'Melee' },
  { range: [97], weapon: 'Sling Bullet', type: 'Ranged' },
...
static scrollsTable = [
  ...
  { range: [41, 46], type: 'Protection from Elementals' },
  { range: [47, 56], type: 'Protection from Lycanthropes' },
  { range: [57, 61], type: 'Protection from Magic' },
  { range: [62, 75], type: 'Protection from Undead' },
